...
function showProfile() {
    document.getElementById('mainContent').innerHTML = '<h2 id="welcomeMessage" class="text-3xl font-bold text-center">My Profile</h2><div id="profileContent" class="text-center mt-4">Your profile information goes here.</div>';
}

// Function to load My Timesheet
function viewMyTimesheet() {
    document.getElementById('mainContent').innerHTML = '<h2 id="welcomeMessage" class="text-3xl font-bold text-center">My Timesheet</h2><div id="timesheetContent" class="text-center mt-4">Your timesheet information goes here.</div>';
}
...
function viewMyPayslip() {
    document.getElementById('mainContent').innerHTML = '<h2 id="welcomeMessage" class="text-3xl font-bold text-center">View My Own Payslip</h2><div id="payslipContent" class="text-center mt-4">Your payslip information goes here.</div>';
}
