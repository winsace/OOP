...
// API endpoint for user login (existing endpoint)
...
// API endpoint to fetch all users (existing endpoint)
...
// API endpoint to create a new user (existing endpoint)
...
// API endpoint to update user details (existing endpoint)
...
// API endpoint to delete a user (existing endpoint)
...
// API endpoint to fetch user details by username (new endpoint)
