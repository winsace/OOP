...
// Function to load My Time Log
function viewMyTimeLog() {
    document.getElementById('mainContent').innerHTML = '<iframe src="timelog.html" class="w-full h-full border-none"></iframe>';
}
...
function showDashboard() {
    document.getElementById('mainContent').innerHTML = '<h2 id="welcomeMessage" class="text-3xl font-bold text-center">Welcome to Portal Dashboard</h2><div id="clock" class="text-center mt-4"></div>';
    showClock();
}
