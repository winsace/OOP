...
document.getElementById('timeInBtn').addEventListener('click', function() {
  ...
  if (timeInValue.textContent !== '') {
    document.getElementById('error').textContent = "You have already recorded time in.";
  } else {
...
document.getElementById('timeOutBtn').addEventListener('click', function() {
  ...
  if (timeInValue.textContent === '') {
    document.getElementById('error').textContent = "Please record time in first.";
  } else if (timeOutValue.textContent !== '') {
    document.getElementById('error').textContent = "You have already recorded time out.";
  } else {
