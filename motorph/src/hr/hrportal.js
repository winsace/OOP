...
// Function to open Employee List
function openEmployeeList() {
    // Replace with the path to your 'dpa' folder
    const payslipSummaryFilePath = '../dpa/employeelist.xlsx';
    window.open(payslipSummaryFilePath, '_blank');
}
...
// Function to view Leave Manager
function viewLeaveManager() {
    document.getElementById('mainContent').innerHTML = '<iframe src="leavemanager.html" class="w-full h-full border-none"></iframe>';
}

// Function to view My Ticket
...
// Function to load Timesheet Manager
function timesheetManager() {
    document.getElementById('mainContent').innerHTML = '<iframe src="timesheetmanager.html" class="w-full h-full border-none"></iframe>';
}
...
function viewMyPayslip() {
    const payslipFilePath = '../dpa/employee2payslip.pdf';
    window.open(payslipFilePath, '_blank');
}
...
// Function to open dpa folder
function openReportsFolder() {
    // Replace with the path to your 'dpa' folder
    const dpaFolderPath = '../dpa';

    window.open(dpaFolderPath, '_blank');
}


// Function to show welcome message and clock
function showDashboard() {
    document.getElementById('mainContent').innerHTML = '<h2 id="welcomeMessage" class="text-3xl font-bold text-center">Welcome to HR Admin Dashboard</h2><div id="clock" class="text-center mt-4"></div>';
    showClock();
}
