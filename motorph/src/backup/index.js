document.addEventListener("DOMContentLoaded", function() {
    ...
    const cancelResetButton = document.getElementById("cancelResetButton"); // Add this line to get the cancel button
    ...
    loginForm.addEventListener("submit", async function(event) {
        ...
        try {
            ...
            if (userCredential) {
                ...
                switch (role) {
                    case "hr":
                        window.location.href = "hrportal.html";
                        break;
                    case "payroll":
                    ...
                    case "employee":
                        ...
                        break;
                    case "it":
                        window.location.href = "itportal.html";
                        break;
                    default:
                        alert('Invalid role.');
                }
