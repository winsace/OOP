...
function calculatePayslip() {
    ...
    if (grossEarnings < 3250) {
        ...
        // Adjust this condition according to your upper limit
        // You may need to adjust it based on your requirements
        // and the maximum value for SSS Contribution
        // Currently, the upper limit is set to 9999999
        // You should replace this value with the appropriate upper limit
        // or adjust the logic accordingly.
        sssContribution = 1125.00;
    } else {
        // You can handle other salary ranges similarly
    ...
    if (grossEarnings <= 20832) {
        withholdingTax = 0;
    } else if (grossEarnings <= 33332) {
        withholdingTax = 0.2 * (grossEarnings - 20833);
    } else if (grossEarnings <= 66666) {
        withholdingTax = 2500 + 0.25 * (grossEarnings - 33333);
    } else if (grossEarnings <= 166666) {
        withholdingTax = 10833 + 0.3 * (grossEarnings - 66667);
    } else if (grossEarnings <= 666666) {
        withholdingTax = 40833.33 + 0.32 * (grossEarnings - 166667);
    } else if (grossEarnings > 666666) {
        withholdingTax = 200833.33 + 0.35 * (grossEarnings - 666667);
    }
